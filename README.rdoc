...
This Rails application is a simple form that creates a new ticket with a new requester. On form submission success, it will create a ticket in the Zendesk backend. When that user logs into their account, they will be able to view all the tickets they've submitted and make comments.
